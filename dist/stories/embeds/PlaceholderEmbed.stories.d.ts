...
declare const StoryComponent: ({ url, linkText, imageUrl, spinner, allowJavaScriptUrls, spinnerDisabled, ...divProps }: import("../../components/placeholder/PlaceholderEmbed").PlaceholderEmbedProps) => any;
